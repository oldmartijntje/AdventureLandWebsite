...
const translations = {
    "cat": {
        ...
        "T.infoText1": "In Adventure Land, yer journey startz to creatin' da most excitin' themepark. Buildz thrillin' attraqtions, hirez da bestest staff, an' investz yer moolah wisely. Complete seekrit mishuns to boostz yer park's popoolarity. Da ultimate goal be to wins da prestiged Award!",
        "T.infoTitle2": "A Majestic Adventurz",
        "T.infoText2": "Adventure Land feelz like a rollercoaster of epic proportions. So much happinz in just an hour dat ya needz a bit of recup'ration. It all kickz off with park auctions. Every park lookz entirely diff'rent in each game. Which one ya chooz? This head start offerz specific chanzes an' possible strategiez from da outset. Will ya specialize in a particular theme? Or will ya hire valyooable staff? Decide to employ janitors an' earn scratch with every built toilet, or play it safe an' take on a gardener for a stable income stream? Da choiz be yers!",
        "T.reviewsTitle": "Reviewz",
        "prevReviewButton": "Prevy Review",
        "nextReviewButton": "Nexty Review",
        "T.linksTitle": "Linkz:",
        "T.instagram": "InstaMeow",
        "T.theGameMaster": "DaGameMasta",
        "T.explanationVideo": "Explenashun Meowtube Video",
